		...
		<div class="main">
			<div class="login-dom">
				<div class="logo text-center">
					<img src="${pageContext.request.contextPath}/Images/logo.png" width="180" height="180">
				</div>
				<!--注册-->
				...
				<form class="register-form" name="register" action="register.do" method="post" >
					<div class="reg-wrap border">
						<div class="reg-number border-bottom">
							<input type="text" class="fl reg-phone" name="uid" id="uid" placeholder="请输入用户名" />
						</div>
						<div class="reg-number">
							<input type="text" name="uname" id="vcode" class="fl padding-big-left reg-code" placeholder="请输入昵称" />
						</div>
						<div class="reg-number">
							<select type="text" name="sex" id="sex" class="fl padding-big-left reg-code" placeholder="请输入性别" >
								<option selected="selected" value="1">男</option>
								<option value="0">女</option>
							</select>
						</div>
						<div class="reg-number">
							<input type="text" name="tel" id="tel" class="fl padding-big-left reg-code" placeholder="请输入手机号码" />
						</div>
						<div class="reg-number">
							<input type="password" name="password" id="password" class="fl padding-big-left reg-code" placeholder="请输入密码" />
						</div>
					</div>
